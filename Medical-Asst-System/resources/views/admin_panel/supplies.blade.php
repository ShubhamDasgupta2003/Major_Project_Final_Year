      ...
      @foreach($medical_supplies_medicals as $medical_supplies_medical)
        <tr>
           <!--   <td></td>-->
            ...
            <td><a href="{{route('admin_panel.update',['medical_supplies_medical'=>$medical_supplies_medical])}}"><i class="fa-solid fa-pen-nib"></i></a></td><td><a onclick="return confirm('Are you sure you want to delete this product');" href="{{route('admin_panel.delete',['medical_supplies_medical'=>$medical_supplies_medical])}}"><i class="fa-solid fa-delete-left"></i></a></td>
           <!-- <td>
