...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            <a class="navlink"
                href="/Minor Project 5th_Sem/Emergency_Medical_Support_System/HomePage/index.php">Home</a>
            <a class="navlink"
                href="/Minor Project 5th_Sem/Emergency_Medical_Support_System/HomePage/index.php#services">Services</a>
            <a class="navlink"
                href="/Minor Project 5th_Sem/Emergency_Medical_Support_System/HomePage/index.php#review">Review</a>
            <a class="navlink"
                href="/Minor Project 5th_Sem/Emergency_Medical_Support_System/HomePage/index.php#footer">Contact Us</a>
        </nav>
        <div class="user-avatar-container">
            <a href="http://localhost/Minor%20Project%205th_Sem/Emergency_Medical_Support_System/HomePage/profile.php"
                id="user-avatar"><i class="fa-solid fa-user fa-lg account-avatar"></i></a>
    ...
    <section class="body-container">
        <div class="contents">
            ...
            <div class="cards">
            @foreach($amb_data as $ambulance)
                <div class='card' id='amb_card'>
                    <img
                        src='https://images.jdmagicbox.com/comp/varanasi/e9/0542px542.x542.200517114047.g7e9/catalogue/narayan-ambulance-service-varanasi-cantt-varanasi-0jqwifqqzh.jpg?clr='>
                    <div class='card-details'>
                        <p class='card-name'>{{$ambulance->amb_name}}</p>
                        <p class='card-address'><i class='fa-solid fa-location-dot'></i> {{$ambulance->amb_town}} {{$ambulance->amb_state}}
                        </p>
                        <div class='card-row'>
                            <p class='card-type'>{{$ambulance->amb_type}}</p>

                        </div>
                        <div class='card-row'>
                            <p class='card-distance'><i class='fa-solid fa-route fa-lg' style='color: #00b37d;'>7 Km</i>
                            </p>
                            <p class='card-fare'>{{$ambulance->amb_rate}} Km/Hr</p>
                        </div>
                        <div class='card-row'>
                            <a0o
                                href='/Minor Project 5th_Sem/Emergency_Medical_Support_System/Ambulance Service/amb_booking_form.php?ambno=$rows[amb_no]&dist=$rows[distance]&booklat=$lat_in_use&booklon=$lon_in_use&amb_fare=$amb_fare&book_adrs=$full_address'><button
                                    class='btn btn-secondary-orange' id='book_btn'>Book ride</button></a>
                            <p id='card-status'>{{$ambulance->amb_status}}</p>
                        </div>
                    </div>
                </div>
            @endforeach
