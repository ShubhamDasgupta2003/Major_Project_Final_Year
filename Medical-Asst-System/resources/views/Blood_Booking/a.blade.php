...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
        <link rel="stylesheet" href="css/BloodBank/a.css">
        ...
        <div class="card">
            <!-- <img src="https://maishacare.com/wp-content/uploads/2022/06/ambulance-service-van-emergency-medical-vehicle-vector-illustration-white-background-ambulance-service-van-emergency-medical-127018462.jpg" alt=""> -->
                ...
                <div class='amb_info_cont'>
                    <h1 class='descp' id='title'>lifeline Blood Center Taldanga</h1>
                    <h3><p class='descp' id='card-address'><i class='fa-solid fa-location-dot'></i>West Bengal,Chinsurah</p></h3>
                    ...
                    <a href="http://127.0.0.1:8000/showBhome"><button class="btn-danger" name="cancel_ride">Cancel Order</button></a>
                </div>
            </div>     
        </div>
    </div>
